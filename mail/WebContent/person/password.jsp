	...
	<div class="center">
		<div class="col-main">
			<div class="main-wrap">
				...
				<form class="am-form am-form-horizontal" action="resetpassword" method="post">
					<div class="am-form-group">
						<label for="user-old-password" class="am-form-label">原密码</label>
						<div class="am-form-content">
							<input type="password" id="user-old-password" name="oldpassword"
					...
					<div class="am-form-group">
						...
						<div class="am-form-content">
							<input type="password" id="user-new-password" name="newpassword"
